...
for($i=0;$i<count($mark);$i++){
    $mar=$mark[$i];
  $sid=$sid1[$i];
$sql="INSERT INTO  midresult(StudentId,ClassId,SubjectId,marks, passMark) VALUES(:studentid,:class,:sid,:marks, :passmark)";
...
$sql="INSERT INTO  midmeritlist(StudentName,UserName,Total,ClassId,MarkObtained,CurrentStatus,Status,StudentId, ClassName) VALUES(:studentname,:username,:total,:classid, :sumx, :currentstatus,:status, :studid, :classname)";
$query = $dbh->prepare($sql);
...
<html lang="en">
    <head>
        ...
        <title>Add Mid Term Result </title>
                    ...
                    <div class="main-page" style=background-color:lightgray>
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div" style=background-color:lightgray>
                                <div class="col-md-6">
                                    <h2 class="title">Publish Mid Term Results</h2>

...
if($lastInsertId)
{
$msg="The student has been added successfully";
}
else 
{
...
<label for="default" class="col-sm-2 control-label">Student Full Name</label>
<div class="col-sm-10">
...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Student`s Gender</label>
<div class="col-sm-10">
<input type="radio" name="gender" value="Male" required="required" checked="">Male <input type="radio" name="gender" value="Female" required="required">Female <input type="radio" name="gender" value="Other" required="required">Other
                                                    ...
                                                    <div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Student`s Class</label>
                                                        <div class="col-sm-10">

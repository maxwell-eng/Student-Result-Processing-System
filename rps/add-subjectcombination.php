...
if($lastInsertId)
{
$msg="The class and subject combination has been added successfully";
}
else 
{
...
<html lang="en">
    <head>
        ...
        <title>Class and Subject Combination </title>
                    ...
                    <div class="main-page" style=background-color:lightgray>
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div" style=background-color:lightgray>
                                <div class="col-md-6">
                                    <h2 class="title">Combine Class and Subject</h2>
...
<div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Name of Subject</label>
                                                        <div class="col-sm-10">
...
<?php }} ?>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-offset-2 col-sm-10">
                                                            <button type="submit" name="submit" class="btn btn-primary" style=background-color:orange>Combine</button>
                                                        </div>
                                                    </div>
                                                </form>

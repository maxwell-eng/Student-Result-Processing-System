...
$classid=$_POST['class']; 
   header("Location: meritlist.php?clsid=$classid&stid=$stidx");
                    ...
                    <div class="main-page" style=background-color:lightgray>
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div" style=background-color:lightgray>
                                <div class="col-md-6">
                                    <h2 class="title">Check End of Term Merit List</h2>
...
<?php }} ?>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-offset-2 col-sm-10">
                                                            <button type="submit" name="submit" class="btn btn-primary" style=background-color:orange>Check</button>
                                                        </div>
                                                    </div>
                                                </form>

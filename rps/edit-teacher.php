...
$dob=$_POST['dob']; 
$status=$_POST['status'];
$sql="update teachers set TeacherName=:teachername,UserName=:username,TeacherEmail=:teacheremail,Gender=:gender,DOB=:dob,Status=:status where TeacherId=:stid ";
$query = $dbh->prepare($sql);
$query->bindParam(':teachername',$studentname,PDO::PARAM_STR);
...
$msg="The teacher details have been updated successfully";
...
$sql = "SELECT teachers.TeacherName,teachers.UserName,teachers.RegDate,teachers.TeacherId,teachers.Status,teachers.TeacherEmail,teachers.Gender,teachers.DOB,classes.ClassName,classes.Section from teachers join classes on classes.id=teachers.ClassId where teachers.TeacherId=:stid";
$query = $dbh->prepare($sql);
$query->bindParam(':stid',$stid,PDO::PARAM_STR);
$query->execute();
...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Teacher`s Gender</label>
<div class="col-sm-10">
...
<?php }?>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Teacher`s Class</label>
                                                        <div class="col-sm-10">
...
<?php }} ?>                                                    
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-offset-2 col-sm-10">
                                                            <button type="submit" name="submit" class="btn btn-primary" style=background-color:orange>Update</button>

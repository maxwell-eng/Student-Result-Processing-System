...
$studentIdentity=$_POST['student']; 
   header("Location: add-attendance.php?stu=$studentIdentity");
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading" style=background-color:lightgray>
                                                <div class="panel-title">
                                                    <h5>Select the student you want to add the attendance</h5>
                                                </div>
                                            </div>
                                        ...
                                        <?php } ?>
                                                <form class="form-horizontal" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Name of Student</label>
                                                        <div class="col-sm-10">
 <select name="student" class="form-control" id="default" required="required">
<option value="">Select Student</option>
<?php $sql = "SELECT * FROM students WHERE ClassId=:classid";
$query = $dbh->prepare($sql);
$query->execute(['classid' => $clname]);
$results=$query->fetchAll(PDO::FETCH_OBJ);
if($query->rowCount() > 0)
{
foreach($results as $result)

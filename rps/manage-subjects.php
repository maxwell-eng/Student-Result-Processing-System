...
<html lang="en">
    <head>
        ...
        <title>Add or Edit Subjects</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div" style=background-color:lightgray>
                                <div class="col-md-6">
                                    <h2 class="title">Add or Edit Subjects</h2>
...
<td>
<a href="edit-subject.php?subjectid=<?php echo htmlentities($result->id);?>" style=color:blue><u>Edit</u></a> 
<a href="delete-user.php?subjectid=<?php echo htmlentities($result->id);?>" style=color:blue><u>Delete</u></a> 
...
<?php $cnt=$cnt+1;}} ?>
                                                ...
                                                <div class="" align=center >
                                                            <a href="create-subject.php" ><button type="" name="" class="btn btn-primary" style=background-color:orange >Add Subject</button></a>
                                                        </div>

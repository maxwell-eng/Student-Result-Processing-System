                    ...
                    <div class="main-page" style=background-color:lightgray>
                        <div class="container-fluid">
                            <div class="row page-title-div" style=background-color:lightgray>
                                <div class="col-md-6">
                                    <h2 class="title">End of Term Merit List</h2>
                                        ...
                                        <?php } ?>
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT meritlist.StudentName,meritlist.UserName,meritlist.Total,meritlist.CurrentStatus,meritlist.MarkObtained from meritlist WHERE ClassId=:class ORDER BY MarkObtained DESC";
$query = $dbh->prepare($sql);
